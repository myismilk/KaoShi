...
<body>
    ...
    <div class="content">
        ...
        <div class="page-header">
            ...
            <div>
                <a href="toAddTFQuestionInterface" class="btn btn-info" id="addScQuestionBtn"><i class="fa fa-edit"></i>添加判断试题 </a>
            </div>
        </div>
                            ...
                            <table id="example0" class="table display">
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="toTFQuestionEdit?questionId=<%=question.getQuestion_id()%>" class="btn btn-info"><i class="fa fa-edit"></i>编辑试题 </a>
                                            <a href="toDeleteTFQuestion?questionId=<%=question.getQuestion_id()%>" class="btn btn-info"><i class="fa fa-trash"></i>删除试题 </a>
                                            <a href="getTFQuestionDetailsById?questionId=<%=question.getQuestion_id()%>" class="btn btn-info"><i class="fa fa-file-text-o"></i>查看详情</a>
                                        </td>
                                    </tr>
                                <%
                                    }
